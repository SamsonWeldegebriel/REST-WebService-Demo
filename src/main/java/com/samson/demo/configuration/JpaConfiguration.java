package com.samson.demo.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.samson.demo.repository")
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.samson.demo.model" });
